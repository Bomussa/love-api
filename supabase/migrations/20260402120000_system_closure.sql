...
ALTER TABLE queues ADD COLUMN IF NOT EXISTS patient_id TEXT;
ALTER TABLE queues ADD COLUMN IF NOT EXISTS gender TEXT;
ALTER TABLE queues ADD COLUMN IF NOT EXISTS entered_at TIMESTAMP;
ALTER TABLE queues ADD COLUMN IF NOT EXISTS left_at TIMESTAMP;
ALTER TABLE queues ADD COLUMN IF NOT EXISTS queue_date DATE DEFAULT CURRENT_DATE;
