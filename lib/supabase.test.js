...
describe('Supabase Client', () => {
  ...
  describe('getSupabaseClient', () => {
    ...
    it('should throw error if SUPABASE_URL is missing', () => {
      ...
      expect(() => getSupabaseClient()).toThrow(/SUPABASE_URL|Missing required environment variable/i);
    });
    ...
    it('regression: should fail client creation when all URL sources are missing', () => {
      delete process.env.SUPABASE_URL;
