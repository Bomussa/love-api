...
export function createEnv() {
  return {
    ...
    SUPABASE_URL: process.env.SUPABASE_URL || 'https://rujwuruuosffcxazymit.supabase.co',
    SUPABASE_KEY: process.env.SUPABASE_SERVICE_ROLE_KEY || process.env.SERVICE_ROLE_SECRET,
