...
/**
 * Routing Mapper & Dynamic Routing System
 * 
 * This module provides mapping between frontend clinic identifiers and 
 * backend database clinic names, as well as weighted load balancing.
 * 
 * @module lib/routing
 */

/**
 * Clinic Mapping Object
 * Maps frontend codes to backend database names.
 * @constant {Object}
 */
const MAP = {
  LAB: 'lab',
 ...
 * Converts a frontend clinic code to its corresponding backend name.
 * If no mapping exists, returns the original code.
 * 
 * @function normalizeClinic
 * @param {string} code - The clinic code from the frontend
 * @returns {string} The normalized clinic name for the backend
 */
export function normalizeClinic(code) {
...
export const CLINICS = {
  vitals: {
    id: 'vitals', name: 'القياسات الحيوية', nameEn: 'Vital Signs', floor: '2', weight: 1.0,
  },
  lab: {
    id: 'lab', name: 'المختبر', nameEn: 'Laboratory', floor: 'M', weight: 1.2,
  },
  xray: {
    id: 'xray', name: 'الأشعة', nameEn: 'X-Ray', floor: 'M', weight: 1.5,
  },
  ecg: {
    id: 'ecg', name: 'تخطيط القلب', nameEn: 'ECG', floor: '2', weight: 1.0,
  },
  audio: {
    id: 'audio', name: 'قياس السمع', nameEn: 'Audiometry', floor: '2', weight: 1.0,
  },
  eyes: {
    id: 'eyes', name: 'العيون', nameEn: 'Ophthalmology', floor: '2', weight: 1.3,
  },
  internal: {
    id: 'internal', name: 'الباطنية', nameEn: 'Internal Medicine', floor: '2', weight: 1.8,
  },
  ent: {
    id: 'ent', name: 'أنف وأذن وحنجرة', nameEn: 'ENT', floor: '2', weight: 1.4,
  },
  surgery: {
    id: 'surgery', name: 'الجراحة العامة', nameEn: 'General Surgery', floor: '2', weight: 1.6,
  },
  dental: {
    id: 'dental', name: 'الأسنان', nameEn: 'Dental', floor: '2', weight: 1.3,
  },
  psychiatry: {
    id: 'psychiatry', name: 'الطب النفسي', nameEn: 'Psychiatry', floor: '2', weight: 1.5,
  },
  derma: {
    id: 'derma', name: 'الجلدية', nameEn: 'Dermatology', floor: '3', weight: 1.2,
  },
  bones: {
    id: 'bones', name: 'العظام', nameEn: 'Orthopedics', floor: '2', weight: 1.4,
  },
};
