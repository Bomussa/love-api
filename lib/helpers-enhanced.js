...
/**
 * Set CORS headers with origin validation - FIXED: Secure whitelist, reject unknown origins
 */
export function setCorsHeaders(res, req) {
  ...
  if (origin && allowedOrigins.includes(origin)) {
    ...
    // Reject requests from unknown origins instead of allowing with wildcard
